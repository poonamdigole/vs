    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="pt-32 px-4 py-12 md:px-24 lg:px-48">
        <header className="text-center mb-12 bg-gradient-to-br from-blue-100 via-white to-blue-200 p-8 rounded-xl">
          <h1 className="text-4xl font-bold text-blue-700 mb-4">Bionic Hand</h1>
          <p className="text-lg text-gray-700 max-w-2xl mx-auto">
            AI-Powered Hand Controlled by Computer Vision
          </p>
        </header>
        ...
        <section className="mb-16 flex flex-col md:flex-row items-center md:items-start gap-8">
            ...
            <div className="w-full md:w-1/2">
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                The Bionic Vision Hand is a smart robotic hand developed by VS Tech Horizon, controlled by AI-based computer vision. 
                It uses a camera to detect gestures, objects, or movements, and responds accordingly, no physical sensors needed. This project introduces students to 
                real-world applications of AI, robotics, and computer vision, making learning highly practical and future-oriented.
              </p>

              {/* Key Features now embedded here */}
              <h2 className="text-2xl font-semibold mb-4">Key Features</h2>
              <ul className="list-disc list-inside text-gray-700 space-y-2">
                <li>The hand operates using live input from a camera, no manual control required.</li>
                <li>Recognizes hand gestures, objects, or visual cues to trigger actions.</li>
                <li>No external sensors, everything is done through vision and AI.</li>
                <li>Processes input and performs actions almost instantly.</li>
                <li>Great for learning computer vision, machine learning, and robotics in one compact project.</li>
              </ul>
            </div>
          </section>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-700">
            This project shows how AI and robotics can work together without human touch, just sight. At VS Tech Horizon, 
            we utilize these projects to teach students how machines can perceive, comprehend, and respond, 
            preparing them for AI-driven careers through hands-on, real-time tech experiences.
          </p>
        </section>

        <div className="text-center">
          <Button className="text-white bg-blue-700 hover:bg-blue-800" onClick={handleRequestQuote}>Inquire About Bionic_Hand</Button>
        </div>
      </div>
