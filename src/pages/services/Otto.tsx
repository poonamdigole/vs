    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="pt-32 px-4 py-12 md:px-24 lg:px-48">
        <header className="text-center mb-12 bg-gradient-to-br from-blue-100 via-white to-blue-200 p-8 rounded-xl">
          <h1 className="text-4xl font-bold text-blue-700 mb-4">Industrial Visit</h1>
          <p className="text-lg text-gray-700 max-w-2xl mx-auto">
            Where Learning Goes Beyond The Classroom - Real Tech, Real People, Real Impact.
          </p>
        </header>
        ...
        <section className="mb-16 flex flex-col md:flex-row items-center md:items-start gap-8">
            ...
            <div className="w-full md:w-1/2">
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                Our Industrial Visit program brings students directly into our company’s real-time tech environment, where innovation 
                happens every day. At VS Tech Horizon, learners get to explore live setups in Robotics, AI, IoT, and Prototyping,
                from product development zones to testing labs. We walk them through our workflow, tools, and technologies while 
                giving them a close-up view of how ideas are turned into functional systems. It's not just a visit, it's an inside look 
                into how a tech company actually builds the future.
              </p>

              {/* Key Features now embedded here */}
              <h2 className="text-2xl font-semibold mb-4">Key Features</h2>
              <ul className="list-disc list-inside text-gray-700 space-y-2">
                <li>Real-time exposure to robotics, AI, IoT, and prototyping workspaces.</li>
                <li>Guided walkthroughs of live projects and product development cycles.</li>
                <li>Interaction with engineers, developers, and R&D teams.</li>
                <li>Demos of tools, frameworks, and internal lab infrastructure.</li>
                <li>Tailored sessions for school, college, and training institute levels.</li>
              </ul>
            </div>
          </section>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-700">
            Students don’t just observe, they experience the pace, process, and passion of a working tech company. Every visit equips them with industry-aligned insight and inspiration to build what’s next.
          </p>
        </section>

        <div className="text-center">
          <Button className="text-white bg-blue-700 hover:bg-blue-800" onClick={handleRequestQuote}>Inquire About Industrial Visit</Button>
        </div>
      </div>
