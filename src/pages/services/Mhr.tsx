    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="pt-32 px-4 py-12 md:px-24 lg:px-48">
        <header className="text-center mb-12 bg-gradient-to-br from-blue-100 via-white to-blue-200 p-8 rounded-xl">
          <h1 className="text-4xl font-bold text-blue-700 mb-4">Awards</h1>
          <p className="text-lg text-gray-700 max-w-2xl mx-auto">
            Best Innovation Towards Tech Education 
          </p>
        </header>
        ...
        <section className="mb-16 flex flex-col md:flex-row items-center md:items-start gap-8">
            ...
            <div className="w-full md:w-1/2">
              <h2 className="text-2xl font-semibold mb-4">Award Recognition</h2>
              <p className="text-gray-700 leading-relaxed mb-6">
                VS Tech Horizon Pvt. Ltd. was honored with the Maharashtra Udyog Bhushan Puraskar 2024 for Best Innovation Towards Tech 
                Innovation. This prestigious state-level recognition celebrates our groundbreaking work in advancing technology-driven 
                educational solutions.
              </p>

              {/* Key Features now embedded here */}
              <h2 className="text-2xl font-semibold mb-4">Award Highlights</h2>
              <ul className="list-disc list-inside text-gray-700 space-y-2">
                <li>Selected from among hundreds of emerging tech startups and innovators.</li>
                <li>Recognized by leading industrial and academic bodies of Maharashtra</li>
                <li>Symbol of our impact on technology, education, and future readiness</li>
            </ul>
            </div>
          </section>
        ...
        <section className="mb-16">
          <h2 className="text-2xl font-semibold mb-4">Our Vision Forward</h2>
          <p className="text-gray-700">
            At VS Tech Horizon, we are committed to building a future where technology bridges gaps, fuels imagination, and shapes 
            the next generation of innovators. This award is not just a recognition — it's a motivation to keep pushing boundaries.
          </p>
        </section>

        {/* <div className="text-center">
          <Button className="text-white bg-blue-700 hover:bg-blue-800"></Button>
        </div> */}
      </div>
