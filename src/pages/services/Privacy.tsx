    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="fixed top-0 w-full bg-white/95 backdrop-blur-md z-50 border-b border-gray-200 shadow-sm">
        <div className="container mx-auto px-4 py-4">
          ...
          {/* MAIN CONTENT */}
      <main className="pt-28 pb-20 px-6 md:px-20 lg:px-40 max-w-6xl mx-auto text-justify">
        <h1 className="text-3xl font-bold mb-4">Privacy Policy</h1>
        <p className="mb-2"><strong>Last updated: July 13, 2024</strong></p>

        <p className="mb-4">
          At VS Tech Horizon Private Limited ("we," "our," or "us"), we are committed to protecting your privacy...
        </p>

        <h2 className="text-xl font-semibold mt-8 mb-2">1. Information We Collect</h2>
        <ul className="list-disc list-inside space-y-2">
          <li><strong>Contact Details:</strong> Name, email address, phone number, and mailing address.</li>
          <li><strong>Educational Information:</strong> Academic background...</li>
          <li><strong>Payment Information:</strong> Billing details...</li>
          <li><strong>Professional Information:</strong> Resume, job experience...</li>
          <li><strong>Device & Usage Info:</strong> Pages visited, time spent...</li>
        </ul>

        <h2 className="text-xl font-semibold mt-8 mb-2">2. How We Use Your Information</h2>
        <ul className="list-disc list-inside space-y-2">
          <li><strong>Service Delivery:</strong> Providing scholarships, training, etc.</li>
          <li><strong>Communication:</strong> Contacting you...</li>
          <li><strong>Marketing:</strong> Newsletters and promotions (opt-out anytime).</li>
          <li><strong>Analytics:</strong> Website performance and improvements.</li>
          <li><strong>Compliance:</strong> Legal obligations.</li>
        </ul>

        <h2 className="text-xl font-semibold mt-8 mb-2">3. Sharing Your Information</h2>
        <ul className="list-disc list-inside space-y-2">
          <li><strong>Service Providers:</strong> Vendors for IT, payments, etc.</li>
          <li><strong>Partners:</strong> Educational institutions we work with.</li>
        </ul>

        <h2 className="text-xl font-semibold mt-8 mb-2">4. Data Retention</h2>
        <p>We keep your personal data only as long as necessary or required by law.</p>

        <h2 className="text-xl font-semibold mt-8 mb-2">5. Children’s Privacy</h2>
        <p>We don’t knowingly collect data from minors under 18 without parental consent.</p>

        <h2 className="text-xl font-semibold mt-8 mb-2">6. Third-Party Links</h2>
        <p>We may link to other websites. Their privacy policies may be different.</p>

        <h2 className="text-xl font-semibold mt-8 mb-2">7. Policy Updates</h2>
        <p>This policy may be updated. We’ll notify users for major changes.</p>

        <h2 className="text-xl font-semibold mt-8 mb-2">8. Contact</h2>
        <p>
          For questions, contact us at <a href="mailto:support@vstechhorizon.com" className="text-blue-600 underline">support@vstechhorizon.com</a>
        </p>
      </main>
